...
const Hero = () => {
  ...
  AI-Powered Resume Builder
          ...
          <div className="flex items-center gap-4 ">
            <Link
              to="/login"
              className="bg-purple-600 hover:bg-purple-700 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-green-400 flex items-center transition-colors"
            >
              Build Resume
              <svg
                xmlns="http://www.w3.org/2000/svg"
